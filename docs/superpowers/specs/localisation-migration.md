...
| cls             | src/commands/cls.c                | not-applicable         | Only output is the literal newline flood + ANSI ESC[2J clear-screen sequence — control bytes, not translatable text. Lives in C as plain write_user. |
